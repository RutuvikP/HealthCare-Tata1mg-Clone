import {
  ...
  const Checkout = () => {
    ...
    let CheckoutData = JSON.parse(localStorage.getItem("Price")) || "";
    ...
    const handleSuccess = () => {
      // BasicUsage() ;
      alert(
        ">>>> Link has been sent to your Registered Mobile No. <<<<             >>>> Confirm the Checkout & Proceed <<<<"
      );
      navigate("/success");
    };
        ...
        <Box height={"auto"} bg={"#F3F7FB"}>
          ...
          <CheckoutNav>
            ...
            <Box mr={8} mt={2} color={"white"} display={"flex"} gap={8}>
              ...
              <Box>
                <Text fontSize={"smaller"}>Checkout Details</Text>
              </Box>
            </Box>
          </CheckoutNav>
            ...
            >
              ...
              >
                ...
                <Box
                  ...
                  width={"100%"}
                >
                  <Text fontSize={"smaller"}>PREFERRED Checkout</Text>
                ...
                >
                  ...
                  >
                    ...
                    <Box fontSize={"sm"}>
                      ...
                      <Text>
                        Link Account is required to complete the Checkout
                      </Text>
                    </Box>
                    <Box color={"#EF4281"} pt={3} fontSize={"smaller"}>
                      {" "}
                ...
                <Box
                  ...
                  width={"100%"}
                >
                  <Text fontSize={"smaller"}> OTHER CheckoutS </Text>
                  <Box display={"flex"} pr={3} justifyContent={"space-between"}>
                    <Box display={"flex"} pt={3} gap={8}>
                      <Image
                        height={30}
                      ...
                      <>
                        <Box textAlign={"left"}>
                          ...
                          <Box display={"flex"} mb={6} gap={8}>
                            <Checkbox />
                            <Text>Save this card for future Checkouts. </Text>
                          </Box>
